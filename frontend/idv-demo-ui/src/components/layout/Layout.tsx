          ...
          <div className="flex justify-between h-16">
            <div className="flex">
              <div className="flex-shrink-0 flex items-center">
                <div className="h-10 w-10 bg-gradient-to-br from-red-600 to-red-700 rounded-lg flex items-center justify-center shadow-md">
                  <span className="text-white font-bold text-sm">P</span>
                </div>
                <div className="ml-3">
                  <h1 className="text-lg font-bold text-gray-900">Prudential</h1>
                  <p className="text-xs text-gray-500 -mt-1">IDV Portal</p>
                </div>
              </div>
              ...
              <div className="flex-shrink-0">
                <div className="flex items-center space-x-4">
                  ...
                  <button
                    ...
                    className="bg-gray-100 p-2 rounded-lg text-gray-600 hover:text-red-600 hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors duration-200"
                    title="Logout"
                  >
